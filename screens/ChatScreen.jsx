...
const ChatScreen = ({ route }) => {
  ...
  return (
    <View className="flex-1">
      <View className="w-full bg-amber-400 px-4 py-6 flex-[0.3]">
        <View className="flex-row items-center justify-between w-full px-4 py-12">
          ...
          <View className="flex-row items-center justify-center space-x-3 ">
            <View className="w-10 h-10 rounded-full border border-white flex items-center justify-center">
          ...
          <>
                    ...
                    msg.user.providerData.email === user.providerData.email ? (
                      <View className="m-1" key={i}>
                        <View
                          ...
                          className="px-4 py-2 rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl bg-amber-500 w-auto relative"
                        >
                      ...
                      >
                        <View className="flex-row items-center justify-center space-x-2">
                          ...
                          {/* text */}
                          <View className="m-1">
                            <View className="px-4 py-2 rounded-tl-2xl rounded-tr-2xl rounded-tr-2xl rounded-br-2xl bg-slate-200 w-auto relative">
            ...
            <View className="w-full flex-row items-center justify-center px-8">
              <View className="bg-gray-200 rounded-2xl px-4 space-x-4 py-2 flex-row items-center justify-center">
                ...
                <TextInput
                  className="flex-1 h-8 text-base text-slate-600 font-semibold"
