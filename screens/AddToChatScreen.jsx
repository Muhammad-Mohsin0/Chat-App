...
const AddToChatScreen = () => {
  ...
  return (
    <View className="flex-1">
      <View className="w-full bg-amber-400 px-4 py-6 flex-[0.25]">
      ...
      <View className="w-full bg-white px-4 py-6 rounded-3xl flex-1 rounded-t-[50px] -mt-10">
        <View className="w-full px-4 py-4">
          <View className="w-full px-4 flex-row items-center justify-between py-3 rounded-xl border border-gray-400 space-x-3">
            {/* icons  */}
            <Ionicons name="chatbubbles" size={24} color={"gray"} />
            {/* text input  */}
            <TextInput
              className="flex-1 text-lg text-slate-500 -mt-1 h-12 w-full"
